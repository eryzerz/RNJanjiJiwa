...
class AnotherMenuItem extends Component {
        ...
        return (
            <View>
                <Modal
                    ...
                    <ScrollView>
                        <View style={{backgroundColor: '#00000080', flex:1, alignItems: 'center', backgroundColor: secondaryColor}}>
                ...
                {item.map((val, id) => (
                    <View key={id} style={{flexDirection: 'row', paddingHorizontal: 10, marginHorizontal: 10, marginBottom: 10}}>
                        ...
                        <View style={{flex: 1}}>
                            ...
                            <View style={{flex:1}}>
                                <TouchableOpacity style={styles.increment} onPress={() => this.setModalVisible(true)}>
                                    <Text style={{ color: secondaryColor}}>+</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
...
export default AnotherMenuItem
